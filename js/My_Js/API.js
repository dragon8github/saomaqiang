...
GetApiUrl = function(ModuleName)
{
	...
	{
		return "http://192.168.22.23:31450/B001_V0001_5un29/ApiIndex.aspx";
	}  
	else if(ModuleName == "B002_V0001_5un29")
	{
		return "http://192.168.22.23:31450/B002_V0001_5un29/ApiIndex.aspx";	
	}
	else if(ModuleName == "B003_V0001_5un29")
	{
		return "http://192.168.22.23:31450/B003_V0001_5un29/ApiIndex.aspx";
	}
	else
	{
